...
public class IndexController {
	...
	public String loginApi(@RequestBody LoginForm form) {
		// Type mismatch: cannot convert from List<User> to
		// List<SecurityProperties.User>のエラー
		// import されてたクラスがsecurityPropertiesだったため、model.entity.userに変更

		List<User> users = userRepos.findByUserNameAndPassword(form.getUserName(), form.getPassword());
		// undefinedとかでていたのは、LoginDto.javaの方でgetUserNameの表記が間違っていたから
